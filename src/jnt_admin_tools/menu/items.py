...
class MenuItem:
    ...
    ``template``
        ...
        Default value: 'jnt_admin_tools/menu/item.html'.
...
class AppList(MenuItem, AppListElementMixin):
    ...
    In addition to the parent :class:`~jnt_admin_tools.menu.items.MenuItem`
    ...
    def init_with_context(self, context):
        """
        Please refer to
        :meth:`~jnt_admin_tools.menu.items.MenuItem.init_with_context`
        documentation from :class:`~jnt_admin_tools.menu.items.MenuItem` class.
        """
    ...
    def is_empty(self):
        ...
        >>> from jnt_admin_tools.menu.items import MenuItem, AppList
...
class ModelList(MenuItem, AppListElementMixin):
    ...
    def is_empty(self):
        ...
        >>> from jnt_admin_tools.menu.items import MenuItem, ModelList
