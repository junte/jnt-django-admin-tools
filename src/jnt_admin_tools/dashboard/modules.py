...
class DashboardModule:
    ...
    ``template``
        ...
        Default value: 'jnt_admin_tools/dashboard/module.html'.
    """

    template = "jnt_admin_tools/dashboard/module.html"
    enabled = True
    draggable = True
    collapsible = True
    deletable = True
    ...
    def init_with_context(self, context):
        """
        Like for the :class:`~jnt_admin_tools.dashboard.Dashboard` class, dashboard
...
class Group(DashboardModule):
    ...
    As well as the :class:`~jnt_admin_tools.dashboard.modules.DashboardModule`
    properties, the :class:`~jnt_admin_tools.dashboard.modules.Group`
    ...
    template = "jnt_admin_tools/dashboard/modules/group.html"
    display = "tabs"
    ...
    def is_empty(self):
        ...
        >>> from jnt_admin_tools.dashboard.modules import DashboardModule, LinkList
        >>> mod = Group()
        >>> mod.is_empty()
        True
...
class LinkList(DashboardModule):
    ...
    As well as the :class:`~jnt_admin_tools.dashboard.modules.DashboardModule`
    properties, the :class:`~jnt_admin_tools.dashboard.modules.LinkList` takes
    ...
    title = _("Links")
    template = "jnt_admin_tools/dashboard/modules/link_list.html"
    layout = "stacked"
...
class AppList(DashboardModule, AppListElementMixin):
    ...
    As well as the :class:`~jnt_admin_tools.dashboard.modules.DashboardModule`
    properties, the :class:`~jnt_admin_tools.dashboard.modules.AppList`
    has two extra properties:
    ...
    template = "jnt_admin_tools/dashboard/modules/app_list.html"
    models = None
    exclude = None
    include_list = None
    exclude_list = None
...
class ModelList(DashboardModule, AppListElementMixin):
    ...
    As well as the :class:`~jnt_admin_tools.dashboard.modules.DashboardModule`
    properties, the :class:`~jnt_admin_tools.dashboard.modules.ModelList` takes
    two extra arguments:
    ...
    template = "jnt_admin_tools/dashboard/modules/model_list.html"
    models = None
    exclude = None
    include_list = None
    exclude_list = None
...
class RecentActions(DashboardModule):
    ...
    As well as the :class:`~jnt_admin_tools.dashboard.modules.DashboardModule`
    properties, the :class:`~jnt_admin_tools.dashboard.modules.RecentActions`
    ...
    template = "jnt_admin_tools/dashboard/modules/recent_actions.html"
    limit = 10
    include_list = None
    exclude_list = None
...
class Feed(DashboardModule):
    ...
    As well as the :class:`~jnt_admin_tools.dashboard.modules.DashboardModule`
    properties, the :class:`~jnt_admin_tools.dashboard.modules.Feed` takes two
    ...
    title = _("RSS Feed")
    template = "jnt_admin_tools/dashboard/modules/feed.html"
    feed_url = None
    limit = None
