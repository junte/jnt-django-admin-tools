...
class AdminBasicTest(TestCase):
    ...
    def test_custom_menu_media(self):
        ...
        self.assertContains(
            response,
            '<link rel="stylesheet" href="/static/test_app/menu.css" type="text/css" media="all"/>',
        )
    ...
    def test_custom_dashboard_media(self):
        ...
        self.assertContains(
            response,
            '<link rel="stylesheet" href="/static/test_app/dashboard.css" type="text/css" media="all"/>',
        )
    ...
    def test_add_dashboard_preferences(self):
        ...
        res = self.client.post(
            reverse(
                "admin-tools-dashboard-set-preferences",
                args=("test-dashboard",),
            ),
    ...
    def test_edit_menu_bookmark(self):
        ...
        bm = Bookmark.objects.create(
            user=user, url="/admin/", title="Test bookmark"
        )
